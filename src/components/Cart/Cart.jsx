            ...
            <div className={styles.Cart__wrapper}>
                <div className={styles.name}>
                    ...
                    <div className={styles.text}>
                        <div className={styles.nameOf}>{props.name}</div>
