        ...
        <div className={styles.footer}>
            <div className={styles.footer__wrapper}>
                <div className={styles.item_i}>
                    ...
                    <div className={styles.logo__name}>Copyright 2021. Antools</div>
                    <div className={styles.infoLogo}>Antool is a web collection of information on paid or free Design and Development tools</div>
                </div>
                <div className={styles.item}>
                    <div className={styles.main}>Contact Us</div>
                    <div className={styles.info}>+621987463</div>
                    <div className={styles.info}>M Building, No.10 A</div>
                    <div className={styles.info}>antools@awesome.com</div>
                </div>
                <div className={styles.item}>
                    <div className={styles.main}>Categories</div>
                    <div className={styles.info}>Design</div>
                    <div className={styles.info}>Development</div>
                </div>
                <div className={styles.item}>
                    <div className={styles.main}>Company Info</div>
                    <div className={styles.info}>About Us</div>
                    <div className={styles.info}>Our Partners</div>
                    <div className={styles.info}>Blog</div>
